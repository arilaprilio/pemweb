        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <p class="text-muted">Berikut adalah daftar pengiriman seluruh customer.</p>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$ord['id']?></td>
                                            <td><?=esc($ord['nama_user'])?></td>
                                            <td><?=esc($ord['created_at'])?></td>
                                            <td><?=esc($ord['nama_produk'])?></td>
                                            <td>JNE1234567890</td>
                                            <td>JNE - REG</td>
                                            <td><?= (new \DateTime(esc($ord['created_at'])))->modify('+3 days')->format('Y-m-d H:i:s') ?></td>
                                            <td><span class="badge bg-info">Sedang Dikirim</span></td>
                                            <td><a href="<?=site_url()?>admin/shipping/detail/<?=esc($ord['id'])?>" class="btn btn-sm btn-primary">Detail</a></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
