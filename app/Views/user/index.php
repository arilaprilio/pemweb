         ...
         <div class="cartmini__wrapper d-flex justify-content-between flex-column">
             ...
             <div class="cartmini__checkout">
                 ...
                 <div class="cartmini__checkout-btn">
                     <a href="/pages/cart.html" class="tp-btn mb-10 w-100"> view cart</a>
                     <a href="/pages/checkout.html" class="tp-btn tp-btn-border w-100"> checkout</a>
                 </div>
             </div>
         </div>
     </div>
                                 ...
                                 <table class="table">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td data-info="title"><a href="<?=site_url()?>pages/product-details.html">Product #1</a></td> <!-- Ini optional sih kalo mau tambahin product details-->
                                          <td data-info="status pending">Pending </td>
                                          <td><a href="/pages/order.html" style="border: 0.1px solid black; padding: 5px 7px;">Detail</a></td>
                                       </tr>
                                       <tr>
                                          <th scope="row"> #2220</th>
                                         <td data-info="title"><a href="<?=site_url()?>pages/product-details.html">Product #2</a></td>
                                          <td data-info="status reply">Dibatalkan</td>
                                          <td><a href="/pages/order.html" style="border: 0.1px solid black; padding: 5px 7px;">Detail</a></td>
                                       </tr>
                                       <tr>
                                          <th scope="row"> #2125</th>
                                          <td data-info="title"><a href="<?=site_url()?>pages/product-details.html">Product #2</a></td>
                                          <td data-info="status done">Sampai</td>
                                          <td><a href="/pages/order.html" style="border: 0.1px solid black; padding: 5px 7px;">Detail</a></td>
                                       </tr>
                                       <tr>
                                          <th scope="row"> #2124</th>
                                          <td data-info="title"><a href="<?=site_url()?>pages/product-details.html">Product #3</a></td>
                                          <td data-info="status hold">Pending</td>
                                          <td><a href="/pages/order.html" style="border: 0.1px solid black; padding: 5px 7px;">Detail</a></td>
                                       </tr>
                                       <tr>
                                          <th scope="row"> #2121</th>
                                          <td data-info="title"><a href="<?=site_url()?>pages/product-details.html">Product #5</a></td>
                                          <td data-info="status done">Sampai</td>
                                          <td><a href="/pages/order.html" style="border: 0.1px solid black; padding: 5px 7px;">Detail</a></td>
                                       </tr>
                                    </tbody>
