...
<head>
 ...
 <!-- cart mini area start -->
     ...
     <!-- cart mini area end -->
      ...
      <main>
         ...
         <section class="tp-checkout-area pb-120" data-bg-color="#EFF1F5">
            <div class="container">
               ...
               <?php $alamat = $addresses[0] ?? []; ?>
               <input type="hidden" name="is_single" value="<?= $is_single ? '1' : '0' ?>">
               <?php if ($is_single): ?>
                  <input type="hidden" name="product_id" value="<?= esc($items[0]['produk_id']) ?>">
                  <input type="hidden" name="qty" value="<?= esc($items[0]['qty']) ?>">
               <?php endif ?>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-7">
                     <div class="tp-checkout-bill-area">
                        <h3 class="tp-checkout-bill-title">Rincian Penagihan</h3>
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                    <div class="tp-checkout-input">
                                       ...
                                       <input type="text" name="nama1" placeholder="Nama Depan" value="<?= $alamat['nama_depan'] ?? '' ?>" required>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="tp-checkout-input">
                                       <label>Nama Belakang <span>*</span></label>
                                       <input type="text" name="nama2" placeholder="Nama Belakang" value="<?= $alamat['nama_belakang'] ?? '' ?>" required>
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="tp-checkout-input">
                                       <label>Alamat Jalan</label>
                                       <input type="text" name="alamat1" placeholder="Nomor rumah dan nama jalan" value="<?= $alamat['alamat1'] ?? '' ?>">
                                    </div>
                                    <div class="tp-checkout-input">
                                       <input type="text" name="alamat2" placeholder="Detail Tambahan (Opsional)" value="<?= $alamat['alamat2'] ?? '' ?>">
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="tp-checkout-input">
                                       <label>Kota</label>
                                       <input type="text" name="kota" placeholder="" value="<?= $alamat['kota'] ?? '' ?>">
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="tp-checkout-input">
                                       <label>Kode Pos</label>
                                       <input type="text" name="kodepos" placeholder="" value="<?= $alamat['kodepos'] ?? '' ?>">
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="tp-checkout-input">
                                       <label>No. HP <span>*</span></label>
                                       <input type="text" name="nohp" placeholder="" required value="<?= $alamat['nohp'] ?? '' ?>">
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="tp-checkout-input">
                                       <label>Alamat Email <span>*</span></label>
                                       <input type="email" name="email" placeholder="" required value="<?= $alamat['email'] ?? '' ?>">
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="tp-checkout-input">
                                       <label>Catatan Pemesanan (opsional)</label>
                                       <textarea name="catatan" placeholder="Catatan tentang pesanan Anda, misalnya catatan khusus untuk pengiriman."><?= $alamat['catatan'] ?? '' ?></textarea>
                                    </div>
                                  </div>
                              </div>
                           </div>
                  ...
                  <div class="col-lg-5">
                     <div class="tp-checkout-place white-bg">
                        <h3 class="tp-checkout-place-title">Pesanan Anda</h3>
                        <div class="tp-order-info-list">
                           <ul>
                              ...
                              <?php foreach ($items as $item): ?>
                                 <li class="tp-order-info-list-item">
                                    <span><?= esc($item['nama']) ?></span>
                                    <span>Rp <?= number_format($item['price'], 0, ',', '.') ?> x <?=esc($item['qty'])?></span>
                                 </li>
                              ...
                              <li class="tp-order-info-list-shipping">
                                 <span><b>Ongkir</b></span>
                                 <div class="tp-order-info-list-shipping-item d-flex flex-column align-items-end">
                                    <span>
                                       <input id="free_shipping" type="radio" name="shipping" value="free" checked>
                                       <label for="free_shipping">Gratis Ongkir</label>
                                    </span>
                                 </div>
                              </li>
                        ...
                        <div class="tp-checkout-payment">
                           ...
                           <div class="tp-checkout-payment-item">
                              ...
                              <div class="tp-checkout-payment-desc cash-on-delivery">
                                 <p>Lakukan pembayaran secara langsung saat barang datang. Harap gunakan ID Pesanan Anda sebagai referensi pembayaran. Pesanan Anda tidak akan dikirim hingga dana masuk ke rekening kami.</p>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="tp-checkout-agree">
                           <div class="tp-checkout-option">
                              <input id="read_all" type="checkbox" name="agree" value="1" required>
                              <label for="read_all">Saya telah membaca dan menyetujui situs web tersebut.</label>
                           </div>
                        </div>

                        <div class="tp-checkout-btn-wrapper">
                           <button type="submit" class="tp-checkout-btn w-100">Checkout</button>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <!-- JS here -->
      </script><script src="<?=site_url()?>assets/js/vendor/jquery.js"></script>
