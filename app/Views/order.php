                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="tp-order-details-item">
                                       ...
                                       <p>April 16, 2023</p> <!-- Tanggal Pemesanan + 4 hari = Perkiraan pengiriman, gt ae rumusnya ril -->
                                    </div>
                                 </div>
                                 <div class="col-sm-6">
                                    <div class="tp-order-details-item">
                           ...
                           <div class="tp-order-info-list">
                              <ul>
                                 ...
                                 <li class="tp-order-info-list-desc">
                                    <p>Nama Produk 1<span> x 2</span></p>
                                    <span>Rp 50.000</span>
                                 </li>
                                 <li class="tp-order-info-list-desc">
                                    <p>Nama Produk 2 <span> x 1</span></p>
                                    <span>Rp 70.000</span>
                                 </li>
                                 <li class="tp-order-info-list-desc">
                                    <p>Nama Produk 3 <span> x 3</span></p>
                                    <span>Rp 120.000</span>
                                 </li>
                                 <li class="tp-order-info-list-desc">
                                    <p>Nama Produk 3 <span> x 1</span></p>
