                  ...
                  <div class="col-xl-6 col-lg-8">
                     <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                           <h3 class="tp-login-title">Masuk ke Beli.in</h3>
                           <p>Belum punya akun? <span><a href="<?=site_url()?>auth/register"> Register</a></span></p>
                        </div>
                        <?=form_open("auth/login/submit", ["class" => "tp-login-option"])?>
                           <div class="tp-login-input-wrapper">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="tp_password" type="password" placeholder="Min. 6 character" name="password" minlength="6">
                                 </div>
                           ...
                           <div class="tp-login-bottom">
                            <button class="tp-login-btn w-100" name="submit">Login</button>
                           </div>
                        <?=form_close()?>
                     </div>
                  </div>
